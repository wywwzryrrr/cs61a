...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        lambda_pro = do_lambda_form(lambda_exp, env)
        env.define(symbol, lambda_pro)  # bind symbol to lamda_procedure
        return symbol
        # END PROBLEM 10
    else:
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        validate_form(binding, 2, 2) # verify the structure is (<name> <expression>)
