def couple(s, t):
    ...
    assert len(s) == len(t)
    "*** YOUR CODE HERE ***"
    lst = [[s[i], t[i]] for i in range(len(s))]
    return lst
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_a, lon_a = city_a['lat'], city_a['lon']
    lat_b, lon_b = city_b['lat'], city_b['lon']
...
def closer_city(lat, lon, city_a, city_b):
    ...
    dis1 = distance(city_a, city)
    dis2 = distance(city_b, city)
    city1, city2 = city_a['name'], city_b['name']
    #print("DEBUG: ", city_a[0], dis1, city_b[0], dis2)
    return city1 if dis1 < dis2 else city2
