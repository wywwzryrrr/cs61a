...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        after = self.balance
        transction = Transaction(self.next_trasaction_id, before, after)
        self.transactions.append(transction)
        self.next_trasaction_id += 1
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            transaction = Transaction(self.next_trasaction_id, before, before)
            self.transactions.append(transaction)
            self.next_trasaction_id += 1
            return 'Insufficient funds'
        self.balance = self.balance - amount
        after = self.balance
        transaction = Transaction(self.next_trasaction_id, before, after)
        self.transactions.append(transaction)
        self.next_trasaction_id += 1
        return self.balance
